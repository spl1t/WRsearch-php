...
<body style="background-image: url(<?=$bgprofile?>); background-position: 49.999% 0; background-size: auto;">
...
<div class="container">
	...
	<table class="sortbale">
		...
		foreach ($PlayerlastRecords as $PlayerlastRecord): ?> 

		<tr>
		<td> <a href="/map.php?mapname=<?=$PlayerlastRecord["map_name"]?>"> <?=$PlayerlastRecord["map_name"]?></a></td>
		<td> <?=formattoseconds($PlayerlastRecord["Time"])?></td>
		<td> <?=$styles[$PlayerlastRecord["Style"]]?>
		</td>
		<td> <?=$PlayerlastRecord["Timestamp"] = gmdate("Y-m-d H:i", $PlayerlastRecord["Timestamp"])?></td>
		</tr>
		<?php  endforeach?>
		</tbody>
	</table>
...
<div class="container">
        ...
        "render":function(data,type,row){
            return '<a href="/player.php?steamid=' +data + '">' + data + '</a>';
            }
